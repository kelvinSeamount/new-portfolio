  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        Outside of coding, I enjoy video games and running .Currently, I&aposm
        improving my backend skills, focusing on
        <span className="italic font-bold"> Node.js.</span> {""}
        I&aposm actively seeking a full-time software developer role and would
        love to collaborate and create something great together! 🙌
      </p>
    </motion.section>
  );
};
